      ...
      do
      {
         ...
         for(;j<n2-1;j++)
         {
            ...
            *pi1++ = s1 + s2;
            ...
            p1 = vgetq_lane_f32(expi.val[0],0) * r2;
            p2 = vgetq_lane_f32(expi.val[1],0) * s2;
            p3 = vgetq_lane_f32(expi.val[0],0) * s2;
            p4 = vgetq_lane_f32(expi.val[1],0) * r2;
            *pi5++ = p1 + p2;
            *pi5++ = p3 - p4;
            //co = *pia2++;
            //si = *pia2++;
            p1 = vgetq_lane_f32(expi.val[0],1) * r1;
            p2 = vgetq_lane_f32(expi.val[1],1) * s1;
            p3 = vgetq_lane_f32(expi.val[0],1) * s1;
            p4 = vgetq_lane_f32(expi.val[1],1) * r1;
            *pi3++ = p1 + p2;
            *pi3++ = p3 - p4;
            //co = *pia2++;
            //si = *pia2++;
            p1 = vgetq_lane_f32(expi.val[0],2) * t1;
            p2 = vgetq_lane_f32(expi.val[1],2) * t2;
            p3 = vgetq_lane_f32(expi.val[0],2) * t2;
            p4 = vgetq_lane_f32(expi.val[1],2) * t1;
            *pi7++ = p1 + p2;
            *pi7++ = p3 - p4;
            r1 = (r6 - r8) * C81;
            s1 = (s6 - s8) * C81;
            ...
            //co = *pia2++;
            //si = *pia2++;
            p1 = vgetq_lane_f32(expi.val[0],3) * r1;
            p2 = vgetq_lane_f32(expi.val[1],3) * s1;
            p3 = vgetq_lane_f32(expi.val[0],3) * s1;
            p4 = vgetq_lane_f32(expi.val[1],3) * r1;
            *pi2++ = p1 + p2;
            *pi2++ = p3 - p4;
            ...
            //co = *pia2++;
            //si = *pia2++;
            p1 = vgetq_lane_f32(expi.val[0],0) * r5;
            p2 = vgetq_lane_f32(expi.val[1],0) * s5;
            p3 = vgetq_lane_f32(expi.val[0],0) * s5;
            p4 = vgetq_lane_f32(expi.val[1],0) * r5;
            *pi8++ = p1 + p2;
            *pi8++ = p3 - p4;
            //co = *pia2++;
            //si = *pia2++;
            p1 = vgetq_lane_f32(expi.val[0],1) * r6;
            p2 = vgetq_lane_f32(expi.val[1],1) * s6;
            p3 = vgetq_lane_f32(expi.val[0],1) * s6;
            p4 = vgetq_lane_f32(expi.val[1],1) * r6;
            *pi6++ = p1 + p2;
            *pi6++ = p3 - p4;
            //co = *pia2++;
            //si = *pia2++;
