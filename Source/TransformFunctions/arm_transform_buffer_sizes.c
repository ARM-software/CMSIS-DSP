 ...
 */
uint32_t arm_cfft_tmp_buffer_size(arm_math_target_arch arch,arm_math_datatype dt,
                              uint32_t nb_samples,
                              uint32_t buf_id)
{
 ...
 */
uint32_t arm_cfft_output_buffer_size(arm_math_target_arch arch,arm_math_datatype dt,
    uint32_t nb_samples)
{
    switch(dt)
    {
 ...
 * @return Length in samples (real numbers) for the output buffer
 */
uint32_t arm_cifft_output_buffer_size(arm_math_target_arch arch,arm_math_datatype dt,
    uint32_t nb_samples)
{
    switch(dt)
    {
 ...
 * @return Length in samples (real numbers) for the temporary buffer
 */
uint32_t arm_rfft_tmp_buffer_size(arm_math_target_arch arch,arm_math_datatype dt,
    uint32_t nb_samples,
    uint32_t buf_id)
{
    switch(dt)
 ...
 * @return Length in samples (real numbers) for the output buffer
 */
uint32_t arm_rfft_output_buffer_size(arm_math_target_arch arch,arm_math_datatype dt,
    uint32_t nb_samples)
{
    switch(dt)
    {
 ...
 */
uint32_t arm_rifft_input_buffer_size(arm_math_target_arch arch,arm_math_datatype dt,
    uint32_t nb_samples)
{
 ...
 * @return Length in samples (real numbers) for the temporary buffer
 */
uint32_t arm_mfcc_tmp_buffer_size(arm_math_target_arch arch,
