        ...
        uint32_t blockSize)
{
  ...
  const float64_t *pb;                                 /* Temporary pointer for coefficient buffer */
        ...
        float64_t acc1, acc2, acc3, acc4, acc5, acc6, acc7;     /* Accumulators */
        float64_t x0, x1, x2, x3, x4, x5, x6, x7;               /* Temporary variables to hold state values */
        float64_t c0;                                           /* Temporary variable to hold coefficient value */
#endif
