...
__ALIGNED(16) char ARM_CACHE_PACKEDB[MAXDT_PACKEDA*INNER_BLOCK*MAXDC];
__ALIGNED(16) char ARM_CACHE_PACKEDA[MAXDT_PACKEDB*ROWS_BLOCK*INNER_BLOCK];
// PACKEDC contains the accumulators
__ALIGNED(16) char ARM_CACHE_PACKEDC[MAXDT_PACKEDC*ROWS_BLOCK*COLS_BLOCK];
