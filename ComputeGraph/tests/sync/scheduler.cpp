...
uint32_t scheduler(int *error)
{
    ...
    */
    ...
    FIFO<float32_t,FIFOSIZE13,0,0> fifo13(buf14);
    FIFO<float32_t,FIFOSIZE14,0,0> fifo14(buf15);
    FIFO<float32_t,FIFOSIZE15,1,0> fifo15(buf16);
    FIFO<float32_t,FIFOSIZE16,1,0> fifo16(buf17);
    FIFO<float32_t,FIFOSIZE17,0,0> fifo17(buf18);
